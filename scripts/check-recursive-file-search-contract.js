...
assertIncludes('syncFilterUi', sliceFunction(app, 'syncFilterUi'), 'state.searchMode ?');
assertIncludes('syncFilterUi content prefix branch', sliceFunction(app, 'syncFilterUi'), 'state.searchContentMode');
