...
assertIncludes('renderStatusbar content search label', renderStatusbar, '内容搜索');
assertIncludes('renderStatusbar content search branch', renderStatusbar, 'state.searchContentMode');
